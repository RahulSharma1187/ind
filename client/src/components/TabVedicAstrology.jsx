...
import "./tabVedicAstrology.css";
import KeyboardArrowLeftIcon from '@mui/icons-material/KeyboardArrowLeft';
import EastIcon from '@mui/icons-material/East';
import { Scrollbars } from 'react-custom-scrollbars-2';
import { Button, TextField } from '@mui/material';

function TabVedicAstrology({onDetailClick, handleBackClick, onNextStep, onTitleSelect, onTextareaVal  }) {
  const [readmore, setReadmore] = useState(false);
  const textareaRef = useRef(null);

  const vedicTabCont = [
    {
      title:"vedic Free Discovery Call",
    ...
    {
      title:"vedic Blood Chemistry Analysis",
...
const handleTextareaValue = (value) => {
  ...
  return (
    <div className='tabVedicAstrology'>
      <Scrollbars style={{ height:'80vh' }} >
        <div className='tabVedicAstrologyHdrImg'>
          <img src="./images/tabFunMedHdrImg.png" alt="" />
        </div>
        <div className='tabVedicAstrologyCont'>
...
const DetailContent = ({ tabCon, readmore, handleReadMore, handleBackClick, onNextStep, textareaRef   }) => (
  <div className='vedAstroDtlBox'>
    <div className='vedAstroDtlBoxBack' onClick={handleBackClick}><KeyboardArrowLeftIcon /> Functional Medicine</div>
    <Scrollbars style={{ height:'78vh' }} >
      <div className={`vedAstroDtlBoxGreyBg ${readmore ? 'vedAstroDtlBoxGreyBgFull' : ''}`}>
        <h3>{tabCon.title}</h3>
...
export default TabVedicAstrology