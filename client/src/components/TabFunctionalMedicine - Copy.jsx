...
function TabFunctionalMedicine({onDetailClick, handleBackClick, onNextStep, onTitleSelect  }) {
  ...
  const handleNext = () => {
    let selectedServiceTitle = document.querySelector('.funMedDtlBoxGreyBg h3').textContent;
    let selectedServiceDescription = textareaRef.current.value;
    onTitleSelect(selectedServiceTitle);
    onNextStep();
  };
